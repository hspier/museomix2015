var jsKeyboard = {
    settings: {
        buttonClass: "key-button", // default button class
    ...
    defaultKeyboard: {
        ...
        // 1st row
               ...
               { value: "Effacer", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "key-button button_del", keyClass: "key key_del" },
        // 2nd row
               { value: 65, buttonClass: "key-button button_a" },{ value: 83 },{ value: 68 },{ value: 70 },
               { value: 71 },{ value: 72 },{ value: 74 },{ value: 75 },{ value: 76 },
               { value: "Entrée", isChar: "false", buttonClass: "key-button button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
               { value: "abc", isChar: "false", buttonClass: "key-button button_smallletter", onclick: "jsKeyboard.changeToSmallLetter();", keyClass: "key key_smallletter" },
               { value: 90 },{ value: 88 },{ value: 67 },{ value: 86 },{ value: 66 },{ value: 78 },
               { value: 77 },{ value: 44 },{ value: 46 },{ value: 64 },
        // 4th row
               { value: "123", isChar: "false", buttonClass: "key-button button_numberleft", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
               { value: "Espace", isChar: "false", buttonClass: "key-button button_space", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
               { value: "#%+", isChar: "false", buttonClass: "key-button button_symbolsright", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" }
            ],
        smallLetter: [
        // 1st row
                ...
                { value: "Effacer", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "key-button button_del", keyClass: "key key_del" },
        // 2nd row
                { value: 97, buttonClass: "key-button button_a" },{ value: 115 },{ value: 100 },{ value: 102 },
                { value: 103 },{ value: 104 },{ value: 106 },{ value: 107 },{ value: 108 },
                { value: "Entrée", isChar: "false", buttonClass: "key-button button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
                { value: "ABC", isChar: "false", buttonClass: "key-button button_capitalletterleft", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
        ...
        // 1st row
                ...
                { value: "Effacer", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "button button_del", keyClass: "key key_del" },
        // 2nd row
                { value: 45, buttonClass: "key-button button_dash" },{ value: 47 },{ value: 58 },{ value: 59 },
        ...
        //3rd row
                ...
                { value: "", isChar: "false", buttonClass: "key-button button_capitalletterleft", onclick: "", keyClass: "key" },
                ...
                { value: "", isChar: "false", buttonClass: "key-button", onclick: "", keyClass: "key" },
                { value: "", isChar: "false", buttonClass: "key-button", onclick: "", keyClass: "key" },

        // 4th row
                { value: "ABC", isChar: "false", buttonClass: "key-button button_numberleft", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
                { value: "Espace", isChar: "false", buttonClass: "key-button button_space", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
                { value: "#%+", isChar: "false", buttonClass: "key-button button_symbolsright", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" }
            ],
        symbols: [
        // 1st row
            ...
            { value: "Effacer", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "key-button button_del", keyClass: "key key_del" },
        // 2nd row
            { value: 95, buttonClass: "key-button button_underscore" },{ value: 92 },{ value: 124 },{ value: 126 },
            { value: 60 },{ value: 62 },
        ...
        // 4th row
            { value: "123", isChar: "false", buttonClass: "key-button button_numberleft", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
            { value: "Espace", isChar: "false", buttonClass: "key-button button_space", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
            { value: "ABC", isChar: "false", buttonClass: "key-button button_symbolsright", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
         ]
    }
}
